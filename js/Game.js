class Game {
  constructor() {
    ...
    //ativação de tecla, prof
    this.leftKeyActive = false;
    //ativação de explosão, aluno
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //crie variável (local) com o nome: currentLife para pegar a vida atual dos jogadores em allPlayers 
        ...
        if (index === player.index) {
          ...
          //chamar método de colisão entre carros aqui embaixo, prof
          this.handleCarACollisionWithCarB(index);

          //chamando o método de colisão carros e obstáculos, c42, prof
          this.handleObstacleCollision(index);

          //if se a vida for menor ou igual a 0 
          //mudar as variáveis para carro não andar mais, aluno
  ...
  //método de colisão carros e obstáculos, prof
  ...
  //carroA com carroB
  //nome: handleCarACollisionWithCarB
